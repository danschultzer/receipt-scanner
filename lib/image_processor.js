...
var Preprocessor = require('./image_processor/preprocessor')
...
ImageProcessor.prototype.process = function (fileOrStream, callback) {
  var self = this
  var outfile = self.processor._tmpName('png')
  ...
  preprocessor.process(fileOrStream, outfile, function (error, outfile) {
